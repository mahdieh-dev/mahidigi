...
import { changeVerifyTagForUser } from "@/lib/database/actions/admin/user.actions"
...
interface EnhancedTableHeadProps {
    numSelected: number
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof UserRow) => void
...
function EnhancedTableHead(props: EnhancedTableHeadProps) {
    ...
    const createSortHandler = (property: keyof UserRow) => (event: React.MouseEvent<unknown>) => {
                    ...
                    >
                        {headCell.id === "delete" || headCell.id === "verified" ? (
                            ...
                            <TableSortLabel
                                ...
                                onClick={createSortHandler(headCell.id as keyof UserRow)}
                                sx={{
...
function UsersTable({ rows }: { rows: UserRow[] }) {
    ...
    const [orderBy, setOrderBy] = useState<keyof UserRow>("name")
    ...
    const handleUserVerify = async (
        ...
        try {
            ...
            const response = await changeVerifyTagForUser(userId, verified)
